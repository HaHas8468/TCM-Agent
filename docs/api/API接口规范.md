...
```json
{
  ...
  "therapy": "水煎服，每日一剂，分两次温服",    // 用法用量（存入 api_clinicrecord.chief_complaint）
...
| 16 | /api/records | GET | 病历检索 |
| 17 | /api/records/{id} | GET | 病历详情 |
| 18 | /api/patient/{id}/history | GET | 患者历史病历 |
...
| 24 | /api/knowledge/case/doctor | GET | 按医生姓名/ID查询医案 |
| 25 | /api/knowledge/case | POST | 新增医案 |
